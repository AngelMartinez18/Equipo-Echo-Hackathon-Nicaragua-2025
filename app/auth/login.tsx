        ...
        <View style={styles.contentContainer}> 
            ...
            <Controller
                ...
                render={({field:{onChange, value}}) =>(
                    ...
                    <TextInput style={styles.input} placeholder="Correo" onChangeText={onChange} value={value} placeholderTextColor="#777"/>
                )}
            />
            ...
            <TouchableOpacity style={styles.button}>
                <View style={styles.bbContent}>
                    ...
                    <Text style={styles.bbText}>Inicar sesion con Facebook</Text>
                </View>
            </TouchableOpacity>
            
            <TouchableOpacity onPress={()=> router.push('/auth/registro')} activeOpacity={0.7}>
